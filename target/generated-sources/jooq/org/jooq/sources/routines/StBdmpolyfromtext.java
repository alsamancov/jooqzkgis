...
public class StBdmpolyfromtext extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1712938321;
    ...
    public StBdmpolyfromtext() {
        super("st_bdmpolyfromtext", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
