...
public class _AddRasterConstraintPixelTypes extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1136045971;
    ...
    public _AddRasterConstraintPixelTypes() {
        super("_add_raster_constraint_pixel_types", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
