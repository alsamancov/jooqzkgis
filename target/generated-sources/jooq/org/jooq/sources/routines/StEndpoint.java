...
public class StEndpoint extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1691955498;
     ...
     */
    public StEndpoint() {
        super("st_endpoint", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
