...
public class StInteriorringn extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -2081764427;
    ...
    public StInteriorringn() {
        super("st_interiorringn", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
