...
public class RasterContainedByGeometry extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -516464137;
    ...
    public RasterContainedByGeometry() {
        super("raster_contained_by_geometry", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
