...
public class StForceCollection extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -513756679;

    /**
     * The parameter <code>public.st_force_collection.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.st_force_collection._1</code>.
     */
    ...
    public StForceCollection() {
        super("st_force_collection", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
