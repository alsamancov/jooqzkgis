...
public class StClipbybox2d extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1340430810;
    ...
    public StClipbybox2d() {
        super("st_clipbybox2d", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
