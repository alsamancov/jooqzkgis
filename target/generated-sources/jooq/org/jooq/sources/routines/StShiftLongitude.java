...
public class StShiftLongitude extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 853641851;

    /**
     * The parameter <code>public.st_shift_longitude.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.st_shift_longitude._1</code>.
     */
    ...
    public StShiftLongitude() {
        super("st_shift_longitude", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
