...
public class _StDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -213578348;

    /**
     * The parameter <code>public._st_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public _StDistance() {
        super("_st_distance", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
