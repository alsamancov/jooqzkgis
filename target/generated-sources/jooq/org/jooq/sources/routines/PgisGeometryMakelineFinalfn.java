...
public class PgisGeometryMakelineFinalfn extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1265984644;
    ...
    public PgisGeometryMakelineFinalfn() {
        super("pgis_geometry_makeline_finalfn", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
