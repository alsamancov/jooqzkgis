...
public class StMemcollect extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -357480650;
     ...
     */
    public StMemcollect() {
        super("st_memcollect", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
