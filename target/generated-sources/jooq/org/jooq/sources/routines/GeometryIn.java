...
public class GeometryIn extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1932974279;
     ...
     */
    public GeometryIn() {
        super("geometry_in", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
