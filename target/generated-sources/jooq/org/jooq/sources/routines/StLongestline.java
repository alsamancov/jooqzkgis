...
public class StLongestline extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1215056856;
    ...
    public StLongestline() {
        super("st_longestline", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
