...
public class PostgisAddbbox extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 2109992313;
    ...
    public PostgisAddbbox() {
        super("postgis_addbbox", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
