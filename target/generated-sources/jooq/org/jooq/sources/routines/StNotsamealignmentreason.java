...
public class StNotsamealignmentreason extends AbstractRoutine<String> {

    private static final long serialVersionUID = -816492916;

    /**
     * The parameter <code>public.st_notsamealignmentreason.RETURN_VALUE</code>.
     */
     ...
     */
    public StNotsamealignmentreason() {
        super("st_notsamealignmentreason", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
