...
public class StGeometryn extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1216082955;
     ...
     */
    public StGeometryn() {
        super("st_geometryn", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
