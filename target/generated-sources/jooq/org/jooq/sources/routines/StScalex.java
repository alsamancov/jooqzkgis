...
public class StScalex extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1395814729;

    /**
     * The parameter <code>public.st_scalex.RETURN_VALUE</code>.
     */
     ...
     */
    public StScalex() {
        super("st_scalex", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
