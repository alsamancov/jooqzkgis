...
public class StRotation extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1999378487;

    /**
     * The parameter <code>public.st_rotation.RETURN_VALUE</code>.
     */
     ...
     */
    public StRotation() {
        super("st_rotation", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
