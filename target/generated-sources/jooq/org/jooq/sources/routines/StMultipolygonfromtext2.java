...
public class StMultipolygonfromtext2 extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1272502768;
    ...
    public StMultipolygonfromtext2() {
        super("st_multipolygonfromtext", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
