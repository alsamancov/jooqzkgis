...
public class StPixelaspoint extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = -1769655959;

    /**
     * The parameter <code>public.st_pixelaspoint.RETURN_VALUE</code>.
     */
     ...
     */
    public StPixelaspoint() {
        super("st_pixelaspoint", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
