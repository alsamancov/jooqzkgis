...
public class RasterOverabove extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -694119494;
    ...
    public RasterOverabove() {
        super("raster_overabove", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
