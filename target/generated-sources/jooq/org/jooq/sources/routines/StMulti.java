...
public class StMulti extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1212133934;
     ...
     */
    public StMulti() {
        super("st_multi", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
