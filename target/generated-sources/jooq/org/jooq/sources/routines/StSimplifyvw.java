...
public class StSimplifyvw extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -735345655;
     ...
     */
    public StSimplifyvw() {
        super("st_simplifyvw", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
