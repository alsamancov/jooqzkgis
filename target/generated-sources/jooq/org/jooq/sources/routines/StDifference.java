...
public class StDifference extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 757527654;
     ...
     */
    public StDifference() {
        super("st_difference", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
