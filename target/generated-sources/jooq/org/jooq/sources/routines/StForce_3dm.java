...
public class StForce_3dm extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = -319570593;

    /**
     * The parameter <code>public.st_force_3dm.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.st_force_3dm._1</code>.
     */
     ...
     */
    public StForce_3dm() {
        super("st_force_3dm", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
