...
public class StForce2d extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 562521290;
     ...
     */
    public StForce2d() {
        super("st_force2d", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
