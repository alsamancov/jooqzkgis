...
public class StRotatey extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -2064465919;
     ...
     */
    public StRotatey() {
        super("st_rotatey", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
