...
public class StMakepointm extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1760398203;
     ...
     */
    public StMakepointm() {
        super("st_makepointm", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
