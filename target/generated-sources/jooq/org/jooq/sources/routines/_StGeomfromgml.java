...
public class _StGeomfromgml extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -852583053;
    ...
    public _StGeomfromgml() {
        super("_st_geomfromgml", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
