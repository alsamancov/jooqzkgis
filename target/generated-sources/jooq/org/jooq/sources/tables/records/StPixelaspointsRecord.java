...
public class StPixelaspointsRecord extends TableRecordImpl<StPixelaspointsRecord> implements Record4<Geometry, Double, Integer, Integer> {

    private static final long serialVersionUID = -1146312311;

    /**
     * Setter for <code>public.st_pixelaspoints.geom</code>.
     */
    ...
    /**
     * Getter for <code>public.st_pixelaspoints.geom</code>.
     */
     ...
     */
    @Override
    public StPixelaspointsRecord value1(Geometry value) {
        setGeom(value);
        return this;
    }
     ...
     */
    @Override
    public StPixelaspointsRecord values(Geometry value1, Double value2, Integer value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StPixelaspointsRecord(Geometry geom, Double val, Integer x, Integer y) {
        super(StPixelaspoints.ST_PIXELASPOINTS);
