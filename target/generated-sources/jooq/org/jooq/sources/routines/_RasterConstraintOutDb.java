...
public class _RasterConstraintOutDb extends AbstractRoutine<Boolean[]> {

    private static final long serialVersionUID = -2146374434;
    ...
    public _RasterConstraintOutDb() {
        super("_raster_constraint_out_db", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN.getArrayDataType());
