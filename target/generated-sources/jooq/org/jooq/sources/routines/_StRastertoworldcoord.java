...
public class _StRastertoworldcoord extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1023546526;
    ...
    /**
     * The parameter <code>public._st_rastertoworldcoord.columnx</code>.
     */
    public static final Parameter<Integer> COLUMNX = createParameter("columnx", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("NULL::integer", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>public._st_rastertoworldcoord.rowy</code>.
     */
    public static final Parameter<Integer> ROWY = createParameter("rowy", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("NULL::integer", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>public._st_rastertoworldcoord.longitude</code>.
     */
    public static final Parameter<Double> LONGITUDE = createParameter("longitude", org.jooq.impl.SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>public._st_rastertoworldcoord.latitude</code>.
     */
     ...
     */
    public _StRastertoworldcoord() {
        super("_st_rastertoworldcoord", Public.PUBLIC);
