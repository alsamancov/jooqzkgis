...
public class _DropRasterConstraintSrid extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -733295225;
    ...
    public _DropRasterConstraintSrid() {
        super("_drop_raster_constraint_srid", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
