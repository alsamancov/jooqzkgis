...
public class StPolyfromtext2 extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 441170204;
    ...
    public StPolyfromtext2() {
        super("st_polyfromtext", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
