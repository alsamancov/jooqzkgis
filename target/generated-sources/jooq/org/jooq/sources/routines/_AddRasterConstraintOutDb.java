...
public class _AddRasterConstraintOutDb extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 415276908;
    ...
    public _AddRasterConstraintOutDb() {
        super("_add_raster_constraint_out_db", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
