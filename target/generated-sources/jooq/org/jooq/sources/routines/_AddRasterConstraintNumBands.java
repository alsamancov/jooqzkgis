...
public class _AddRasterConstraintNumBands extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1555674436;
    ...
    public _AddRasterConstraintNumBands() {
        super("_add_raster_constraint_num_bands", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
