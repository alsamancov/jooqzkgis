...
public class StMakevalid extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -828582535;
     ...
     */
    public StMakevalid() {
        super("st_makevalid", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
