...
public class PostgisDropbbox extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 971646083;
    ...
    public PostgisDropbbox() {
        super("postgis_dropbbox", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
