...
public class _AddRasterConstraintBlocksize extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1744201448;
    ...
    public _AddRasterConstraintBlocksize() {
        super("_add_raster_constraint_blocksize", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
