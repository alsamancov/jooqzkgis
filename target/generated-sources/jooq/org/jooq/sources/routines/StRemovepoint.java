...
public class StRemovepoint extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 85172085;
    ...
    public StRemovepoint() {
        super("st_removepoint", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
