...
public class _AddRasterConstraintAlignment extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 755179212;
    ...
    public _AddRasterConstraintAlignment() {
        super("_add_raster_constraint_alignment", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
