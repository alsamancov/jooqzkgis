...
public class _RasterConstraintInfoOutDb extends AbstractRoutine<Boolean[]> {

    private static final long serialVersionUID = -1509660039;

    /**
     * The parameter <code>public._raster_constraint_info_out_db.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BOOLEAN.getArrayDataType(), false, false);
    ...
    public _RasterConstraintInfoOutDb() {
        super("_raster_constraint_info_out_db", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN.getArrayDataType());
