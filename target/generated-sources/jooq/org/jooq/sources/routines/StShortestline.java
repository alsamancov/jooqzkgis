...
public class StShortestline extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1039653224;
    ...
    public StShortestline() {
        super("st_shortestline", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
