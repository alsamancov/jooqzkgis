...
public class StBdpolyfromtext extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 404307707;
    ...
    public StBdpolyfromtext() {
        super("st_bdpolyfromtext", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
