...
public class StRotatez extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1649282399;
     ...
     */
    public StRotatez() {
        super("st_rotatez", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
