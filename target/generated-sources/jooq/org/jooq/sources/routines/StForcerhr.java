...
public class StForcerhr extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1040760250;
     ...
     */
    public StForcerhr() {
        super("st_forcerhr", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
