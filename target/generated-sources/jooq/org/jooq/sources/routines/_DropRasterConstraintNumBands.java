...
public class _DropRasterConstraintNumBands extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -148667900;
    ...
    public _DropRasterConstraintNumBands() {
        super("_drop_raster_constraint_num_bands", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
