...
public class StTransform8 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 795736697;
     ...
     */
    @java.lang.Deprecated
    public static final Parameter<Object> ALIGNTO = createParameter("alignto", org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), false, false);
    ...
    /**
     * Set the <code>alignto</code> parameter IN value to the routine
     */
    public void setAlignto(Object value) {
        setValue(ALIGNTO, value);
    }

    /**
     * Set the <code>alignto</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    public void setAlignto(Field<Object> field) {
        setField(ALIGNTO, field);
    }
