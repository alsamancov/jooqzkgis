...
public class _StLongestline extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 29262694;
    ...
    public _StLongestline() {
        super("_st_longestline", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
