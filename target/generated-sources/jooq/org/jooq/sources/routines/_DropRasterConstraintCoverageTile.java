...
public class _DropRasterConstraintCoverageTile extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1151287036;
    ...
    public _DropRasterConstraintCoverageTile() {
        super("_drop_raster_constraint_coverage_tile", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
