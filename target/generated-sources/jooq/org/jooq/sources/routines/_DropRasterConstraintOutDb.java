...
public class _DropRasterConstraintOutDb extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1257383820;
    ...
    public _DropRasterConstraintOutDb() {
        super("_drop_raster_constraint_out_db", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
