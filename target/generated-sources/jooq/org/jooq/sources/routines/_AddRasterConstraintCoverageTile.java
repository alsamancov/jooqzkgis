...
public class _AddRasterConstraintCoverageTile extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1077485448;
    ...
    public _AddRasterConstraintCoverageTile() {
        super("_add_raster_constraint_coverage_tile", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
