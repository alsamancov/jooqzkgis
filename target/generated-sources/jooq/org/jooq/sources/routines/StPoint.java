...
public class StPoint extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 2053414788;
     ...
     */
    public StPoint() {
        super("st_point", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
