...
public class StBuildarea extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1544373548;
     ...
     */
    public StBuildarea() {
        super("st_buildarea", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
