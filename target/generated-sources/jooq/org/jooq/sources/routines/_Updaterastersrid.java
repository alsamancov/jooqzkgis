...
public class _Updaterastersrid extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -884272681;
    ...
    public _Updaterastersrid() {
        super("_updaterastersrid", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
