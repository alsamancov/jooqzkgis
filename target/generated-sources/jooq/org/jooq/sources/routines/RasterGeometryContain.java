...
public class RasterGeometryContain extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1990890874;
    ...
    public RasterGeometryContain() {
        super("raster_geometry_contain", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
