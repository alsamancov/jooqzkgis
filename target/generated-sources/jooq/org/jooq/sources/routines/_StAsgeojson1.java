...
public class _StAsgeojson1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1448452384;

    /**
     * The parameter <code>public._st_asgeojson.RETURN_VALUE</code>.
     */
     ...
     */
    public _StAsgeojson1() {
        super("_st_asgeojson", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
