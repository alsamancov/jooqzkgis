...
public class StForce_3d extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = -65121786;

    /**
     * The parameter <code>public.st_force_3d.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.st_force_3d._1</code>.
     */
     ...
     */
    public StForce_3d() {
        super("st_force_3d", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
