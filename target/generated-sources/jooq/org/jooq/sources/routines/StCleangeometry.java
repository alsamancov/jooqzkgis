...
public class StCleangeometry extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -591821716;
    ...
    public StCleangeometry() {
        super("st_cleangeometry", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
