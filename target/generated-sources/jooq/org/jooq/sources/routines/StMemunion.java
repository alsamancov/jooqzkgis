...
public class StMemunion extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -188502287;
     ...
     */
    public StMemunion() {
        super("st_memunion", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
