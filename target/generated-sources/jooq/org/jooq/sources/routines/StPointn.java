...
public class StPointn extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1246991339;
     ...
     */
    public StPointn() {
        super("st_pointn", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
