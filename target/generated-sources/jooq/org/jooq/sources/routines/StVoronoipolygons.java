...
public class StVoronoipolygons extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1091379596;
    ...
    public StVoronoipolygons() {
        super("st_voronoipolygons", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
