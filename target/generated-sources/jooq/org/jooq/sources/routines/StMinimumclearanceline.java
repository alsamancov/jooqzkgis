...
public class StMinimumclearanceline extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 227361097;
    ...
    public StMinimumclearanceline() {
        super("st_minimumclearanceline", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
