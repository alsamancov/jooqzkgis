...
public class StExteriorring extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 2046213277;
    ...
    public StExteriorring() {
        super("st_exteriorring", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
