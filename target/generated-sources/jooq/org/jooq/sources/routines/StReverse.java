...
public class StReverse extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 239254629;
     ...
     */
    public StReverse() {
        super("st_reverse", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
