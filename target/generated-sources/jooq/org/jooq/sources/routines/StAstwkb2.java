...
public class StAstwkb2 extends AbstractRoutine<byte[]> {
    ...
    private static final long serialVersionUID = 666368989;
     ...
     */
    public static final Parameter<Object[]> GEOM = createParameter("geom", org.jooq.impl.DefaultDataType.getDefaultDataType("geometry").getArrayDataType(), false, false);

    /**
     * The parameter <code>public.st_astwkb.ids</code>.
     */
    public static final Parameter<Long[]> IDS = createParameter("ids", org.jooq.impl.SQLDataType.BIGINT.getArrayDataType(), false, false);
