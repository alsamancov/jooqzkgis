...
public class RasterLeft extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1233872708;
     ...
     */
    public RasterLeft() {
        super("raster_left", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
