...
public class StSharedpaths extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -941032500;
    ...
    public StSharedpaths() {
        super("st_sharedpaths", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
