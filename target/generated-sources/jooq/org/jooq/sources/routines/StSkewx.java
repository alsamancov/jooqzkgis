...
public class StSkewx extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1547492849;

    /**
     * The parameter <code>public.st_skewx.RETURN_VALUE</code>.
     */
     ...
     */
    public StSkewx() {
        super("st_skewx", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
