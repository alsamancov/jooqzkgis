...
public class GeometryContainedByRaster extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2028613324;
    ...
    public GeometryContainedByRaster() {
        super("geometry_contained_by_raster", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
