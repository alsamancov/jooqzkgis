...
public class StBoundary extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1069934879;
     ...
     */
    public StBoundary() {
        super("st_boundary", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
