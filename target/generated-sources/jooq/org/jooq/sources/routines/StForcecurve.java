...
public class StForcecurve extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 68498663;
     ...
     */
    public StForcecurve() {
        super("st_forcecurve", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
