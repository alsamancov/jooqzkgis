...
public class _RasterConstraintInfoExtent extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = -2057411023;
    ...
    public _RasterConstraintInfoExtent() {
        super("_raster_constraint_info_extent", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
