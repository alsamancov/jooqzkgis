...
public class StSplit extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1997522072;
     ...
     */
    public StSplit() {
        super("st_split", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
