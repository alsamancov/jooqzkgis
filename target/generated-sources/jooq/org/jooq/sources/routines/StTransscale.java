...
public class StTransscale extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -209796887;
     ...
     */
    public StTransscale() {
        super("st_transscale", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
