...
public class StStartpoint extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 755520157;
     ...
     */
    public StStartpoint() {
        super("st_startpoint", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
