...
public class StLinetocurve extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -625263776;
    ...
    public StLinetocurve() {
        super("st_linetocurve", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
