...
public class StPixelaspolygon extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = -383104087;

    /**
     * The parameter <code>public.st_pixelaspolygon.RETURN_VALUE</code>.
     */
     ...
     */
    public StPixelaspolygon() {
        super("st_pixelaspolygon", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
