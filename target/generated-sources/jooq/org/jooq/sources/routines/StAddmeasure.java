...
public class StAddmeasure extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1802368212;
     ...
     */
    public StAddmeasure() {
        super("st_addmeasure", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
