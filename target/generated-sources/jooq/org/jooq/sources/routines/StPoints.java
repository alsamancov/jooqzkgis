...
public class StPoints extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -24186168;
     ...
     */
    public StPoints() {
        super("st_points", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
