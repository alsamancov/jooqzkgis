...
public class _DropRasterConstraintSpatiallyUnique extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 740360176;
    ...
    public _DropRasterConstraintSpatiallyUnique() {
        super("_drop_raster_constraint_spatially_unique", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
