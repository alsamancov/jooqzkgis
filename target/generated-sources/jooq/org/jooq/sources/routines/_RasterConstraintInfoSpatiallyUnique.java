...
public class _RasterConstraintInfoSpatiallyUnique extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1551129389;
    ...
    public _RasterConstraintInfoSpatiallyUnique() {
        super("_raster_constraint_info_spatially_unique", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
