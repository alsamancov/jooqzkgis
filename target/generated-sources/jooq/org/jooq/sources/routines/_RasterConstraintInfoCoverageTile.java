...
public class _RasterConstraintInfoCoverageTile extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -768198843;
    ...
    public _RasterConstraintInfoCoverageTile() {
        super("_raster_constraint_info_coverage_tile", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
