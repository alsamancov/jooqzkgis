...
public class GeometryRecv extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1354740024;
     ...
     */
    public GeometryRecv() {
        super("geometry_recv", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
