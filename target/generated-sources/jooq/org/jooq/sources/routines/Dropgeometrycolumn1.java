...
public class Dropgeometrycolumn1 extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1009562320;
     ...
     */
    public static final Parameter<String> CATALOG_NAME = createParameter("catalog_name", org.jooq.impl.SQLDataType.VARCHAR, false, false);
    ...
    public Dropgeometrycolumn1() {
        super("dropgeometrycolumn", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
