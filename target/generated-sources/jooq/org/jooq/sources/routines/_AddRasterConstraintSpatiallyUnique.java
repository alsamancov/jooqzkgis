...
public class _AddRasterConstraintSpatiallyUnique extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 451259452;
    ...
    public _AddRasterConstraintSpatiallyUnique() {
        super("_add_raster_constraint_spatially_unique", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
