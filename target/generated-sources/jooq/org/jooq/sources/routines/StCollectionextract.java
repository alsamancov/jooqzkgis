...
public class StCollectionextract extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = 117060117;
    ...
    public StCollectionextract() {
        super("st_collectionextract", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
