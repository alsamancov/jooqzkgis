...
public class StSymdifference extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -176563456;
    ...
    public StSymdifference() {
        super("st_symdifference", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
