...
public class StDumpvalues extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = -507188230;

    /**
     * The parameter <code>public.st_dumpvalues.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.st_dumpvalues.nband</code>.
     */
    public static final Parameter<Integer> NBAND = createParameter("nband", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.st_dumpvalues.exclude_nodata_value</code>.
     */
     ...
     */
    public StDumpvalues() {
        super("st_dumpvalues", Public.PUBLIC, org.jooq.impl.SQLDataType.FLOAT.getArrayDataType());
