...
public class RasterOverleft extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1557668252;
    ...
    public RasterOverleft() {
        super("raster_overleft", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
