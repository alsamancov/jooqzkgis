...
public class StSkewy extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 2127223409;

    /**
     * The parameter <code>public.st_skewy.RETURN_VALUE</code>.
     */
     ...
     */
    public StSkewy() {
        super("st_skewy", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
