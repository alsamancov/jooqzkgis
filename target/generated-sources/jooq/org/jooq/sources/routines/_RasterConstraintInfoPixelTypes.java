...
public class _RasterConstraintInfoPixelTypes extends AbstractRoutine<String[]> {

    private static final long serialVersionUID = 836409540;
    ...
    public _RasterConstraintInfoPixelTypes() {
        super("_raster_constraint_info_pixel_types", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
