...
public class StForce_4d extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = -320891449;

    /**
     * The parameter <code>public.st_force_4d.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.st_force_4d._1</code>.
     */
     ...
     */
    public StForce_4d() {
        super("st_force_4d", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
