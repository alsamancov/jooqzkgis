...
public class _DropRasterConstraintExtent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1754808535;
    ...
    public _DropRasterConstraintExtent() {
        super("_drop_raster_constraint_extent", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
