...
public class StPolygon2 extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = 1938817134;
    ...
    /**
     * The parameter <code>public.st_polygon.band</code>.
     */
     ...
     */
    public StPolygon2() {
        super("st_polygon", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
