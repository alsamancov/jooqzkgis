...
public class StMultipolyfromwkb1 extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -492469730;
    ...
    public StMultipolyfromwkb1() {
        super("st_multipolyfromwkb", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
