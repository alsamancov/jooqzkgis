...
public class StSymmetricdifference extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1117812672;
    ...
    public StSymmetricdifference() {
        super("st_symmetricdifference", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
