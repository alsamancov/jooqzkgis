...
public class _StNeighborhood extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = 65700730;

    /**
     * The parameter <code>public._st_neighborhood.RETURN_VALUE</code>.
     */
     ...
     */
    public _StNeighborhood() {
        super("_st_neighborhood", Public.PUBLIC, org.jooq.impl.SQLDataType.FLOAT.getArrayDataType());
