...
public class StRotatex extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 1815317857;
     ...
     */
    public StRotatex() {
        super("st_rotatex", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
