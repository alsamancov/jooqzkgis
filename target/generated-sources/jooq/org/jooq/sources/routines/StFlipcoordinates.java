...
public class StFlipcoordinates extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 940489305;
    ...
    public StFlipcoordinates() {
        super("st_flipcoordinates", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
