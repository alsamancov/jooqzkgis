...
public class StForce_2d extends AbstractRoutine<Geometry> {

    private static final long serialVersionUID = 190647877;

    /**
     * The parameter <code>public.st_force_2d.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.st_force_2d._1</code>.
     */
     ...
     */
    public StForce_2d() {
        super("st_force_2d", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
