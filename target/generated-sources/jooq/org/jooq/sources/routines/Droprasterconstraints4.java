...
public class Droprasterconstraints4 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1705341730;
     ...
     */
    public static final Parameter<Boolean> REGULAR_BLOCKING = createParameter("regular_blocking", org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("true", org.jooq.impl.SQLDataType.BOOLEAN)), true, false);
