...
public class StPointonsurface extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -1295757395;
    ...
    public StPointonsurface() {
        super("st_pointonsurface", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
