...
public class StForcepolygonccw extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -243449409;
    ...
    public StForcepolygonccw() {
        super("st_forcepolygonccw", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
