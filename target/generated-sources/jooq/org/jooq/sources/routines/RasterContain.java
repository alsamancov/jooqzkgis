...
public class RasterContain extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1599352124;
    ...
    public RasterContain() {
        super("raster_contain", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
