...
public class StUnaryunion extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = 2032829003;
     ...
     */
    public StUnaryunion() {
        super("st_unaryunion", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
