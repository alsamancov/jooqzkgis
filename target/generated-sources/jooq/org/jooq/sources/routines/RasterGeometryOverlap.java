...
public class RasterGeometryOverlap extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -58567443;
    ...
    public RasterGeometryOverlap() {
        super("raster_geometry_overlap", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
