...
public class _RasterConstraintInfoIndex extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -846264084;

    /**
     * The parameter <code>public._raster_constraint_info_index.RETURN_VALUE</code>.
     */
     ...
     */
    public _RasterConstraintInfoIndex() {
        super("_raster_constraint_info_index", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
