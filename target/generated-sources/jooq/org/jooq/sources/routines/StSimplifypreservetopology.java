...
public class StSimplifypreservetopology extends AbstractRoutine<Geometry> {
    ...
    private static final long serialVersionUID = -386883435;
    ...
    public StSimplifypreservetopology() {
        super("st_simplifypreservetopology", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"), new GeometryConverter());
